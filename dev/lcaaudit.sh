...
Description: Audits the TREE LCA (tree.commonAncestorLevel) against the STRING LCA (CladeIndex.lineageLCA) on real (taxID,lineage) pairs from a spectra DB.

Usage: lcaaudit.sh <args>   (arguments are parsed by clade.LcaAudit; run the class or read
