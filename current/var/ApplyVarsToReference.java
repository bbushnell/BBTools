...
/**
 * Applies genomic variations to reference sequences, creating modified chromosome arrays.
 * Processes variant files (SNPs, insertions, deletions) and integrates them into reference
 * genomes while maintaining sequence coordinate consistency. Supports regeneration of N-blocks
 * for proper gap handling and provides options to stay near reference coordinates.
 *
