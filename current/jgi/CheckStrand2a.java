 ...
 *
 */
public class CheckStrand2a implements Accumulator<CheckStrand2a.ProcessThread> {
	...
	public static void main(String[] args){
		...
		CheckStrand2a x=new CheckStrand2a(args);
	 ...
	 * @param args Command line arguments
	 */
	public CheckStrand2a(String[] args){
...
//		outstream.println(Tools.readsBasesOut(readsProcessed, basesProcessed, readsOut, basesOut, 8, false));
	...
	private ConcurrentReadInputStream makeCris(){
		ConcurrentReadInputStream cris=ConcurrentReadInputStream.getReadInputStream(
				maxReads, true, ffin1, ffin2, null, null);
