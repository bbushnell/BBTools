...
/**
 * LC history CF table trainer for AVDLL64 (variable-depth history).
 ...
 * <p>
 * Modulo bucket selection matching AVDLL64 production behavior.
 *
 * Usage: java cardinality.LCHistTrainerAVDLL64 buckets=1536 hbits=2 iters=1m t=4
 *
 * @author Neptune
 * @date April 2026
 */
public class LCHistTrainerAVDLL64 {
	...
	public static void main(String[] args){
		...
		System.err.println("LCHistTrainerAVDLL64: buckets="+buckets+" hbits="+hbits+
		...
		try{
			...
			pw.println("#LC_HISTORY_TABLE_AVDLL64");
