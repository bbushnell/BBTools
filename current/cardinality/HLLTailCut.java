...
/**
 * HLL-TailCut+: Relative-offset HyperLogLog with shared base register.
 * <p>
 * Based on Xiao, Zhou, Chen "Better with Fewer Bits" (IEEE INFOCOM 2017).
 * Uses 3-bit offset registers (K=8) plus a shared base register B.
 ...
 * </ul>
 * <p>
 * <b>Vulnerability under test:</b> relative-offset encoding loses information
 * on base advance.  Truncated registers (stored K-1 when true offset was higher)
...
public final class HLLTailCut extends CardinalityTracker {
	...
	HLLTailCut(int buckets_, int k_, long seed, float minProb_){
		super(buckets_, k_, seed, minProb_);
		offsets=new byte[buckets];
	}

	@Override
	public HLLTailCut copy(){return new HLLTailCut(buckets, k, -1, minProb);}
	...
	public static final int K=1<<REGISTER_BITS; // 8
