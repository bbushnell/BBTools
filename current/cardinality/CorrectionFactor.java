...
public class CorrectionFactor{
	...
	private static int colNameToType(String name){
		...
		if("Mean16_cf".equals(name)){return MEAN16;}
		if("VWMean_cf".equals(name)){return VWMEAN;}
		if("MeanTC_cf".equals(name)){return MEANTC;}
		if("MeanTCH_cf".equals(name)){return MEANTCH;}
		return -1;
	}
	...
	public static final int OCCUPIED=0, MEAN=1, HMEAN=2, HMEANM=3, GMEAN=4, HLL=5,
		...
		MEANH=17, MEANM=18, WORDEST=19, HC=20, MEAN16=21, VWMEAN=22, MEANTC=23, MEANTCH=24;
	...
	// AVDLL64 MeanH (history-blended): R²=0.9999995, maxErr=0.00017, terminal=1.00003
	static final double[] MCF_AVDLL64_MEANH={
		 0.943541729472868,  0.234472068869745,  3.514006226473408,  5.776647798476283,
		-0.399965358421230, 13.012834521176437,  1.096089838603468,
		 0.221977283039249,  9.652217021093630,  1.622068385099651,
		-0.327386611768011, 11.010499021852221,  2.283782129250532,
		 0.397895305213694,  1.200087536837342,  6.660793180804890};
	// AVDLL64 VWMean CF: R²=0.9999996, maxErr=0.00028, terminal=1.36011
	static final double[] VWCF_AVDLL64={
		-0.755672940654605,  0.940255110613847,  2.178129385070389,  4.279539408381265,
		-0.005036509822827, 11.152705331847628,  1.443122482524381,
		-0.912217589267775, 11.585472867484365,  1.948464490988030,
		 0.110566503044807, 12.553054044396980,  1.058391499267946,
		-0.386332676364184,  8.328866900455996,  3.765194525832581};
	...
	// AVDLL64 HC CF: R²=0.9999685, maxErr=0.00097, terminal=0.99789
	private static final double HC_CF_AVDLL64_T =   0.997890893774493;
	private static final double HC_CF_AVDLL64_A = 364.318126598440244;
	private static final double HC_CF_AVDLL64_B =   0.993029063208767;
	private static final double HC_CF_AVDLL64_S0=  -0.000420152721003;
	private static final double HC_CF_AVDLL64_S1=   0.000031719457430;
	private static final double HC_CF_AVDLL64_C0=  -0.000663540687510;
