...
public final class BankedCompressedDynamicLogLog5 extends CardinalityTracker {
	...
	/** Terminal CFs, measured 128k ddls 128t (May 9 2026). Exact match to prior measurement. */
	@Override public float terminalMeanCF(){return 0.880151f;}
	@Override public float terminalMeanPlusCF(){return 1.090756f;}

	/** HC weight for LDLC blend. Calibrated by Eru, 2026-04-22. */
	@Override public double ldlcHcWeight(){return 0.40;}
	/** HLDLC weight. Calibrated by Eru, 2026-04-22: 32k DDLs, 1536 buckets. */
	@Override public float hldlcWeight(){return OVERRIDE_HLDLC_WEIGHT>=0 ? OVERRIDE_HLDLC_WEIGHT : 0.66f;}
