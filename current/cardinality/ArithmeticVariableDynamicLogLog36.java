...
/**
 * Arithmetic-encoded variable-history DLL with 6 buckets per 36-bit word.
 * Full arithmetic state encoding (base-RADIX) with variable history tiers.
 * Tiers 0..HIST_TIER_LIMIT have 2-bit history; higher tiers have none.
 *
 * @author Noire
 * @date May 2026
 */
public final class ArithmeticVariableDynamicLogLog36 extends CardinalityTracker {

	/*--------------------------------------------------------------*/
	/*----------------        Initialization        ----------------*/
	/*--------------------------------------------------------------*/

	ArithmeticVariableDynamicLogLog36(){this(2048, 31, -1, 0);}

	ArithmeticVariableDynamicLogLog36(parse.Parser p){
		this(p.loglogbuckets, p.loglogk, p.loglogseed, p.loglogMinprob);
	}

	ArithmeticVariableDynamicLogLog36(int buckets_, int k_, long seed, float minProb_){
	...
	@Override public ArithmeticVariableDynamicLogLog36 copy(){return new ArithmeticVariableDynamicLogLog36(modBuckets, k, -1, minProb);}
	...
	public final void add(CardinalityTracker log){
		...
		add((ArithmeticVariableDynamicLogLog36)log);
	}

	public void add(ArithmeticVariableDynamicLogLog36 log){
		added+=log.added;
		lastCardinality=-1;
	...
	public static int HIST_TIER_LIMIT=14;
	static int RADIX=64;
	...
	public static final String SBS_FILE="?cardinalityCorrectionAVDLL36_LC2BitHistSBS.tsv.gz";
