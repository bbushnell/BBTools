...
public final class ProtoLogLog16c extends CardinalityTracker {
	...
	@Override
	public ProtoLogLog16c copy(){return new ProtoLogLog16c(buckets, k, -1, minProb);}
	...
	/** Configure mode and select the appropriate correction tables. */
	public static void setMode(int mode){
		...
		if(mode==MODE_HISTORY){
			...
			if(HISTORY_BITS==1 && MANTISSA_BITS==3){TIER_TABLES=CF_HISTMANT_1H3M_TIERS;}
				...
				// Outer product of history tier CFs x mantissa CFs
	 ...
	 * @return {ldlc, dlc, hc, lcMin, fgra, hll, meanH, hybridPlus2}
	 */
	...
	/** Minimum nlzStored (absNlz+1) across filled buckets, 0 before all filled. */
	private int minNlzStored=0;
	/** Buckets at minNlzStored; 0 means not yet tracking. */
