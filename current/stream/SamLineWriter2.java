 ...
 */
public class SamLineWriter2 extends SamWriter2 {
	...
	public static void main(String[] args){
		...
		SamWriter2 writer=SamWriter2.makeWriter(ffout, DEFAULT_THREADS, ss.header, true);
...
//			System.err.println("Added list "+list.id);
	...
	/** Constructor. */
	SamLineWriter2(FileFormat ffout_, int threads_,
	...
	private class ProcessThread extends Thread {
		...
		void writeOutput(){
			...
			synchronized(SamLineWriter2.this) {
