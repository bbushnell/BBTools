 ...
 */
public final class LongHashMap2 implements Serializable {
	...
	private static void bench(long[] keys, int repeats){
		...
		
		{
			...
			Shared.printMemory();
			t.start();
			LongHashMap2 map=null;
			long sum=0;
			for(int r=0; r<repeats; r++){
				map=new LongHashMap2();
				for(int i=0; i<size; i++){
					map.put(keys[i], i);
				}
				for(int i=0; i<size; i++){
	 ...
	 */
	public LongHashMap2(int initialSize){
	 ...
	 */
	public LongHashMap2(int initialSize, float loadFactor_){
	 ...
	 */
	public void putAll(LongHashMap2 map){
	 ...
	 */
	public void incrementAll(LongHashMap2 map){
		for(int i=0; i<map.keys.length; i++){
			if(map.keys[i]!=map.invalid){
	 ...
	 */
	public void setToMax(LongHashMap2 map){
		for(int i=0; i<map.keys.length; i++){
