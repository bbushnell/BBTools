...
public final class ListNum_old<K extends Serializable> implements Serializable, Iterable<K>, HasID {
	...
	public ListNum_old(ArrayList<K> list_, long id_){
		list=list_;
		id=id_;
		if(GEN_RANDOM_NUMBERS && list!=null){
			for(K k : list){
				if(k!=null && k.getClass()==Read.class){((Read)k).rand=randy.nextDouble();}
			}
		}
	}
	...
	public final boolean poison() {return list==null;}
	public final boolean last() {return list==null;} //Probably
