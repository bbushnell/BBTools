	...
	public static ArrayList<DDLRecord> loadFile(String path, int k){
		...
		for(byte[] line=bf.nextLine(); line!=null; line=bf.nextLine()){
			...
			if(line[0]=='#'){
				...
				if(lp.termEquals("#tid", 0)){currentTid=(int)lp.parseLong(1);}
			...
			DDLRecord rec=new DDLRecord(ddl, currentTid, currentName);
			...
			currentTid=-1; currentName=null; currentFile=null;
